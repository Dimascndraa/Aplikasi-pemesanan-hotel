...
$dataKamar = query("SELECT * FROM kamar WHERE jenis_kamar = 'deluxe' && status = 'tersedia' ORDER BY status DESC");
$i = 1;
...
<body>
    <h2 align=center>Stok Kamar Deluxe</h2>
...
$mpdf = new \Mpdf\Mpdf();
$mpdf->WriteHTML($html);
$mpdf->Output('stok-kamar-deluxe.pdf', "I");
